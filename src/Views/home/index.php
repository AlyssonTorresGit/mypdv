...
<section class="home hg-full">
    <div class="container-100 flex justify-end"></div>
    <div class="box-6">
    ...
    <div class="box-6 bg-primario flex justify-center item-centro hg-full">
        ...
        <form action="" class="box-10" method="POST">
            ...
            <p class="txt-c fonte14 mg-b-3 fnc-laranja-claro poppins-black">Acesse o sistema com suas credenciais de acesso
            </p>
