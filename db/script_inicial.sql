...
-- alterar tabela movimentacao
ALTER TABLE movimentacao ADD COLUMN TOTALFECHAMENTO DECIMAL(10,2) NOT NULL;
ALTER TABLE movimentacao ADD COLUMN DATAFECHAMENTO DATETIME;
;
